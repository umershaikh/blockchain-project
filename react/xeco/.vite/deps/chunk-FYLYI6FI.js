...
var SECURE_SITE = "https://secure.web3modal.com";
var ConstantsUtil = {
...
var CoreHelperUtil = {
  ...
  parseError(error) {
    ...
    if (typeof error === "string") {
      return error;
    } else if (typeof ((_b2 = (_a4 = error == null ? void 0 : error.issues) == null ? void 0 : _a4[0]) == null ? void 0 : _b2.message) === "string") {
...
var OptionsController = {
  ...
  setEnableAnalytics(enableAnalytics) {
    state3.enableAnalytics = enableAnalytics;
  },
...
var ConnectorController = {
  ...
  addConnector(connector) {
    ...
    if (connector.id === "w3mEmail") {
      ...
      (_b2 = (_a4 = emailConnector == null ? void 0 : emailConnector.provider) == null ? void 0 : _a4.syncDappData) == null ? void 0 : _b2.call(_a4, {
  ...
  getEmailConnector() {
    return state4.connectors.find((c) => c.type === "EMAIL");
  },
  getAnnouncedConnectorRdns() {
    return state4.connectors.filter((c) => c.type === "ANNOUNCED").map((c) => {
      var _a4;
      return (_a4 = c.info) == null ? void 0 : _a4.rdns;
    });
  },
  getConnectors() {
...
var SIWEController = {
  ...
  setSIWEClient(client) {
    ...
    state14.isSiweEnabled = client.options.enabled;
  },
  setNonce(nonce) {
    state14.nonce = nonce;
  },
...
@lit/reactive-element/development/decorators/query-assigned-nodes.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FYLYI6FI.js.map
